...
about: Report a bug or unexpected behavior while using the BastWAN-WLE Board.
...
Any feedback/suggestions should be discussed on the [feedback section](https://github.com/ElectronicCats/BastWAN-WLE/issues):
